...
function CardTemplate({ data, team, circuit }: TemplateProps) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden" style={{ fontFamily: "'Inter', sans-serif", backgroundColor: '#0e0e16', border: `3px solid ${color}` }}>
      ...
      <div className="absolute left-1/2 -translate-x-1/2 w-[98%] h-24 z-[1] opacity-55 pointer-events-none" style={{ top: '62%' }}>
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-[92%] h-28 z-5 pointer-events-none opacity-90">
                  <img 
