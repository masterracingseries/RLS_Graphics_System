...
const F1_TEAMS: Team[] = [
  { 
    ...
    // Auto 2026 alojado localmente — ver nota LOCAL_ASSETS arriba
    car: '/assets/autos_f1/auto_redbull.png',
    color: '#0600ef' 
  },
  { 
    id: 'ferrari', 
    ...
    car: '/assets/autos_f1/auto_ferrari.png',
    color: '#ef1a2d' 
  },
  { 
    id: 'mercedes', 
  ...
  { 
    ...
    car: '/assets/autos_f1/auto_mclaren.png',
    color: '#ff8700' 
  },
  { 
    id: 'aston-martin', 
    ...
    car: '/assets/autos_f1/auto_astonmartin.png',
    color: '#006f62' 
  },
  { 
    id: 'alpine', 
    ...
    car: '/assets/autos_f1/auto_alpine.png',
    color: '#0090ff' 
  },
  { 
    id: 'williams', 
    ...
    car: '/assets/autos_f1/auto_williams.png',
    color: '#005aff' 
  },
  {
    id: 'rb',
    ...
    car: '/assets/autos_f1/auto_racingbull.png',
    color: '#6692ff'
  },
  {
    id: 'audi',
    ...
    car: '/assets/autos_f1/auto_audi.png',
    color: '#bb0a14'
  },
  {
    id: 'cadillac',
    ...
    car: '/assets/autos_f1/auto_cadillac.png',
    color: '#cc0000'
  },
  { 
    id: 'haas', 
    ...
    car: '/assets/autos_f1/auto_haas.png',
    color: '#ffffff' 
  },
];
...
function EsportsTemplate({ data, team, circuit }: TemplateProps) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden" style={{ fontFamily: "'Inter', sans-serif", backgroundColor: '#05070a' }}>
      ...
      <div className="absolute top-[8px] right-[6px] z-30 flex flex-col items-center">
      ...
      <AnimatePresence>
        {submitSuccess && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-6 right-4 left-4 sm:left-auto sm:w-80 bg-green-600 text-white px-4 py-3 rounded-xl text-xs font-bold shadow-2xl z-[200] border border-white/20"
          >
      ...
      <AnimatePresence>
        {downloadError && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            className="fixed top-6 right-4 left-4 sm:left-auto sm:w-80 bg-red-600 text-white px-4 py-3 rounded-xl text-xs font-bold shadow-2xl z-[200] border border-white/20 flex items-center justify-between"
          >
